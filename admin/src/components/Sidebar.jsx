    ...
    <div className='max-sm:flexCenter max-xs:pb-3 rounded bg-white pb-3 sm:w-1/5 sm:min-h-screen'>
      <div className='flex flex-col gap-y-6 max-sm:items-center sm:flex-col pt-4 sm:pt-14 '>
        ...
        <div className='flex sm:flex-col gap-x-5 gap-y-8 sm:pt-10'>
            ...
            <NavLink to={'/reviews'} className={({isActive}) => isActive ? "active-link" :"flexStart gap-x-2 sm:pl-12 p-5 medium-15 cursor-pointer h-10 rounded-xl"}>
                <MdRateReview />  
            ...
            <NavLink to={'/warehouse'} className={({isActive}) => isActive ? "active-link" :"flexStart gap-x-2 sm:pl-12 p-5 medium-15 cursor-pointer h-10 rounded-xl"}>
                <MdRateReview />
                <div className='hidden lg:flex'>Kho hàng</div>
            </NavLink>
            {/* log out */}
